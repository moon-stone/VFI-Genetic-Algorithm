...
public class Main {
	...
	//	Map<Integer, Integer> processor_to_island = new HashMap<Integer, Integer>();
		...
		for(int i = 0; i < no_of_subtasks; i++) {
		 ...
		 for(int i = 0; i < no_of_machines; i++) {
			 ...
			 total_energy = total_energy + busy_energy[i];
		 ...
		 for(int i = 0; i < no_of_machines; i++) {
			 ...
			 total_energy = total_energy + idle_energy[i];
	...
	//	int check = 0;
		...
		//finding inter island communication for this subtask
		for(int i = 0; i < no_of_subtasks; i++) {
			if(predecessor_mat[subtask][i] == 1 && subtask_to_processor[i] % 2 != subtask_to_processor[subtask] % 2) {
				island_communication++;
			}
		}
	//	System.out.println("comm. cost " + subtask + " " + island_communication);
